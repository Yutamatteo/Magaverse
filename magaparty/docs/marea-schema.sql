...
-- Stesso ruolo 'ingresso' usato per i timbri MagaCard: un solo
-- account/accesso staff per tutti i format (MagaCard + Marea).
-- ============================================================
...
-- Non serve creare un ruolo "marea" dedicato: chi ha già il ruolo
-- 'ingresso' (o 'admin'/'superadmin') da MagaCard può scansionare
-- automaticamente anche i QR d'ingresso di Marea, dalla stessa
-- pagina staff (/magacard/staff/). Il ruolo 'bar' NON può scansionare
-- i QR d'ingresso: continua a occuparsi solo dei punti MagaCard.
--
