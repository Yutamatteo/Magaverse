...
(function () {
    ...
    // Evento: 8 Luglio 2026, 16:00 → 00:30 (+1)
    // ─────────────────────────────────────────────────────────
    const LINEUP = [
        { name: 'H8DAPREP',     start: [18,  0], end: [21,  0] },
        { name: 'ADOLFO CITRO', start: [21,  0], end: [24, 30] },
    ];

    function toMinutes(h, m) { return h * 60 + m; }

    function getCurrentDJ(now) {
        const eventDay = new Date('2026-07-08T00:00:00+02:00');
    ...
    function updateDynamicCard() {
        const now = new Date();
        const eventStart = new Date('2026-07-08T16:00:00+02:00');
        const eventEnd   = new Date('2026-07-09T00:30:00+02:00');
    ...
    function addToCalendar() {
        ...
        const det = encodeURIComponent('Una notte nella giungla. 2 DJ. Dalle 16:00 a mezzanotte.');
        window.open(`https://calendar.google.com/calendar/r/eventedit?text=${t}&dates=20260708T160000/20260709T000000&location=${l}&details=${det}`, '_blank');
    }
