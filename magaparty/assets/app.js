...
(function () {
    ...
    function buildSidebar() {
        ...
        <aside class="desktop-sidebar">
            ...
            <a href="/oceanbeach/" class="maga-back-link" style="margin:16px 0 4px;">&#8592; Nello Ocean Beach</a>
    ...
    function buildMobileTabs() {
        ...
        return `
        <div class="mobile-sticky-tabs" style="position:sticky;top:0;z-index:40;backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);border-bottom:1px solid rgba(255,248,231,0.05);box-shadow:0 10px 20px rgba(0,0,0,0.5);background:rgba(20,15,12,0.95)">
    ...
    function buildBottomCta() {
        return `
        <div class="bottom-cta-mobile" style="position:fixed;bottom:0;left:0;right:0;padding:16px;z-index:50;background:linear-gradient(to top, var(--night-surface), rgba(20,15,12,0.9), transparent)">
    ...
    function buildModal() {
        return `
        <div id="listModal" data-testid="list-modal" style="position:fixed;inset:0;z-index:100;display:none;align-items:center;justify-content:center;padding:16px;background:rgba(20,15,12,0.92);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px)">
