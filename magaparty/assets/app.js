...
(function () {
    ...
    // ─────────────────────────────────────────────────────────
    const NAV = [
        { id: 'home',       href: 'index.html',          icon: 'fa-house',        label: 'HOME',       mobileIcon: 'fa-house' },
        { id: 'chi-siamo',  href: 'chi-siamo.html',      icon: 'fa-heart',        label: 'CHI SIAMO',  mobileIcon: 'fa-heart' },
        { id: 'info',       href: 'evento.html#info',    icon: 'fa-circle-info',  label: 'INFO',       mobileIcon: 'fa-sun' },
        { id: 'lineup',     href: 'evento.html#lineup',  icon: 'fa-compact-disc', label: 'LINE-UP' },
        { id: 'orari',      href: 'evento.html#orari',   icon: 'fa-regular fa-clock', label: 'ORARI' },
        { id: 'bar',        href: 'bar.html',            icon: 'fa-martini-glass', label: 'BAR' },
        { id: 'galleria',   href: 'galleria.html',       icon: 'fa-camera',       label: 'GALLERIA' },
        { id: 'tickets',    href: 'evento.html#tickets', icon: 'fa-ticket',       label: 'TICKETS' },
        { id: 'social',     href: 'evento.html#social',  icon: 'fa-hashtag',      label: 'SOCIAL' }
    ];
    ...
    function buildMobileHeader() {
        ...
        <div class="mobile-header-wrapper">
            <header style="padding:40px 24px 24px;text-align:center">
                ...
                <a href="/" class="maga-back-link" style="justify-content:center;margin-top:12px;">&#8592; Magaverse</a>
            </header>
        </div>`;
    }
