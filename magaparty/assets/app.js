...
(function () {
    ...
    // Evento: 8 Luglio 2026, 16:00 → 00:30 (+1) · DJ set dalle 21:00
    // ─────────────────────────────────────────────────────────
    const LINEUP_NAMES = ['H8DAPREP', 'ADOLFO CITRO'];
    ...
    function updateDynamicCard() {
        ...
        const djSetStart  = new Date('2026-07-08T21:00:00+02:00');
        ...
        if (now < eventStart) {
            ...
            if (now < djSetStart) {
                setText('live-dj-name', 'APERTO');
                setText('live-dj-time', 'DJ set dalle 21:00');
            } else {
                setText('live-dj-name', LINEUP_NAMES.join(' • '));
                setText('live-dj-time', 'DJ set in corso');
            }
        } else {
